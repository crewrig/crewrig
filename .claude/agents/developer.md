---
name: developer
description: "Generic implementation agent. Writes, edits, and refactors code with the smallest correct change. Verifies locally before reporting done. Run this agent on the sonnet model."
metadata:
  provenance:
