...
echo "  2. bash scripts/switch-mempalace-http.sh     # mints a new one, replaces the"
echo "                                               # daemon process, and re-registers"
echo "                                               # every CLI"
echo "     The new token only takes effect once step 2 has replaced the daemon"
echo "     process (spec 0139) — it fails visibly rather than report a completed"
echo "     switch while the daemon still honours the old one."
