...
- **Invocation:** `python3 "$HOME/.claude/skills/nano-banana/scripts/nano_banana.py" generate --model gemini-3-pro-image --out docs/assets/mempalace-mcp/topology.png --prompt "<exact prompt text below>"`
