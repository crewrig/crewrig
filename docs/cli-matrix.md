...
| 8 | Hook-integration manifest                                  | `hooks/`                                         | ✅ `hooks/claude-transcript-hooks.json` (UserPromptSubmit, PostToolUse, Stop, SessionEnd) | ✅ `hooks/gemini-transcript-hooks.json` (BeforeAgent, AfterTool, AfterModel, SessionEnd) | ✅ `hooks/copilot-transcript-hooks.json` + inline `hooks:` in `.github/copilot/settings.json` (SessionStart, UserPromptSubmit, PostToolUse, Stop, SessionEnd) |
...
| 10 | Interactive setup script                                  | `scripts/`                                       | ✅ `scripts/setup-claude-interactive.sh`            | ✅ `scripts/setup-gemini-interactive.sh`            | ✅ `scripts/setup-copilot-interactive.sh`           |
...
| 12 | Component-management script                               | `scripts/`                                       | ✅ `scripts/manage-claude-component.sh`             | ✅ `scripts/manage-workspace-component.sh` (Gemini target) | ❌ No `manage-copilot-component.sh` yet — **[GAP]** (follow-up) |
...
- [GAP] Component-management script — no `scripts/manage-copilot-component.sh` yet. Follow-up: extend `scripts/manage-workspace-component.sh` with a Copilot target.
