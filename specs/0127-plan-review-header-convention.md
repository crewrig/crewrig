...
Given a plan comment `## PLAN — issue #833 (spec 0127)` posted on logbook issue #833
...
Given a revised plan comment `## PLAN v2 — issue #833 (spec 0127) — revision after REQUEST CHANGES review`
